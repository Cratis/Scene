...
describe('when rendering a page', () => {
    describe('and the screen asks for the title to be shown', () => {
        ...
        it('should render the title as the heading', () => expect(screen.getByRole('heading', { name: 'Invoices' })).to.exist);
        it('should render the content slot', () => expect(screen.getByText('Body')).to.exist);
    });
    ...
    describe('and the screen leaves the title hidden', () => {
        ...
        it('should still render the content slot', () => expect(screen.getByText('Body')).to.exist);
    });
