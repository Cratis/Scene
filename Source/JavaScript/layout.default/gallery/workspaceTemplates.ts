...
export const dashboardTemplate: ScreenTemplate = {
    ...
    content: {
        ...
        [TemplateSlotName.Primary]: [
            widget('widget-revenue', 'Revenue over time', [externalComponent('revenue-chart', 'chart', { type: 'line' })]),
...
export const detailViewTemplate: ScreenTemplate = {
    ...
    content: {
        ...
        [TemplateSlotName.Body]: [
            ...
            widget('detail-history', 'Price history', [externalComponent('detail-chart', 'chart', { type: 'bar' })]),
        ],
