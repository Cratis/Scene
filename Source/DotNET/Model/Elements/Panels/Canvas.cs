...
/// it sits through the <c language="csharp">Canvas.Left</c>, <c language="csharp">Canvas.Top</c>, <c language="csharp">Canvas.Right</c> and <c language="csharp">Canvas.Bottom</c>
...
/// <remarks>
/// <para>
/// Named for <c language="csharp">@cratis/components</c>' <c language="csharp">Canvas</c>, which is the surface a Cratis application actually
...
public record Canvas : Panel
{
    ...
    /// <c language="csharp">Canvas.Left</c>/<c language="csharp">Canvas.Top</c> pair is measured against.
    /// </summary>
    /// <remarks>
